...
import (
	...
	"github.com/Jaylenwa/Vfoy/v3/pkg/filesystem/driver/oss"
	"github.com/Jaylenwa/Vfoy/v3/pkg/filesystem/driver/upyun"
...
func WebDAVAuth() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if !ok {
			c.Writer.Header()["WWW-Authenticate"] = []string{`Basic realm="vfoy"`}
