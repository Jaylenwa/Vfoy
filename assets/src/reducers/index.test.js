...
import vfoyApp, { initState as vfoyState } from "./index";
...
describe("index reducer", () => {
    it("should return the initial state", () => {
        expect(vfoyApp(undefined, { type: "@@INIT" })).toEqual(initState);
    });

    it("should handle redux init", () => {
        expect(vfoyApp(undefined, { type: "@@redux/INIT" })).toEqual(
            initState
        );
    });
    ...
    it("should handle DRAWER_TOGGLE", () => {
        ...
        expect(vfoyApp(initState, openAction)).toEqual({
            ...initState,
            viewUpdate: {
        ...
        expect(vfoyApp(initState, clossAction)).toEqual({
            ...initState,
            viewUpdate: {
                ...initState.viewUpdate,
                open: false,
    ...
    it("should handle CHANGE_VIEW_METHOD", () => {
        ...
        expect(vfoyApp(initState, action)).toEqual({
            ...initState,
            viewUpdate: {
                ...initState.viewUpdate,
    ...
    it("should handle CHANGE_CONTEXT_MENU", () => {
        ...
        expect(vfoyApp(initState, action1)).toEqual({
            ...initState,
            viewUpdate: {
                ...initState.viewUpdate,
                contextOpen: false,
        ...
        expect(vfoyApp(initState, action2)).toEqual({
            ...initState,
            viewUpdate: {
                ...initState.viewUpdate,
                contextOpen: true,
    ...
    it("should handle SET_NAVIGATOR", () => {
        ...
        expect(vfoyApp(navState, action)).toEqual({
            ...initState,
            navigator: {
                ...initState.navigator,
                path: "/newpath",
    ...
    it("should handle TOGGLE_DAYLIGHT_MODE", () => {
        ...
        expect(vfoyApp(initState, action)).toEqual(darkState);
        expect(vfoyApp(darkState, action)).toEqual(lightState);
    });
    ...
    it("should handle APPLY_THEME", () => {
        ...
        expect(vfoyApp(stateWithThemes, action)).toEqual({
            ...stateWithThemes,
            siteConfig: {
    ...
    it("should handle CHANGE_SUB_TITLE", async () => {
        ...
        expect(document.title).toEqual("test sub title - Vfoy");
    });
    ...
    it("should handle SHOW_IMG_PREIVEW", () => {
        ...
        expect(vfoyApp(showImgState, action)).toEqual({
            ...showImgState,
            explorer: {
