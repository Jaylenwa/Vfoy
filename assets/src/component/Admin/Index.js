                ...
                <Paper>
                    <div className={classes.logoContainer}>
                        <img
                            ...
                            src={"/static/img/vfoy.svg"}
                        />
                        <div className={classes.title}>
                            <Typography className={classes.vfoy}>
                                Vfoy
                            </Typography>
                    ...
                    <div>
                        <List component="nav" aria-label="main mailbox folders">
                            ...
                            <ListItem
                                button
                                onClick={() =>
                                    window.open("https://docs.vfoy.org/")
                                }
                            >
                                <ListItemIcon>
                                    <Description />
                            ...
                            <ListItem
                                button
                                onClick={() =>
                                    window.open("https://vfoy.org/pro")
                                }
                            >
