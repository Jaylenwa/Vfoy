...
//				AddRow("admin@vfoy.org", "admin", "CKLmDKa1C9SD64vU:76adadd4fd4bad86959155f6f7bc8993c94e7adf", "{}"),
//			expected: serializer.BuildUserResponse(model.User{
//				Email: "admin@vfoy.org",
//				Nick:  "admin",
//				Policy: model.Policy{
//					Type:              "local",
...
//		//邮箱格式不正确
//		{
//			reqBody:  `{"userName":"admin@vfoy","captchaCode":"captchaCode","Password":"admin123"}`,
...
//				AddRow("admin@vfoy.org", "admin", "CKLmDKa1C9SD64vU:76adadd4fd4bad86959155f6f7bc8993c94e7adf", "{}", model.Baned),
...
//				AddRow("login_captcha", "0", "login"),
//			userRows: sqlmock.NewRows([]string{"email", "nick", "password", "options", "status"}).
//				AddRow("admin@vfoy.org", "admin", "CKLmDKa1C9SD64vU:76adadd4fd4bad86959155f6f7bc8993c94e7adf", "{}", model.NotActivicated),
...
func TestSiteConfigRoute(t *testing.T) {
	...
	router.ServeHTTP(w, req)
	asserts.Equal(200, w.Code)
	asserts.Contains(w.Body.String(), "Vfoy")
