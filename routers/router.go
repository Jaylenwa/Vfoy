...
import (
	"github.com/Jaylenwa/Vfoy/v3/middleware"
	...
	wopi2 "github.com/Jaylenwa/Vfoy/v3/pkg/wopi"
	"github.com/Jaylenwa/Vfoy/v3/routers/controllers"
...
func InitCORS(router *gin.Engine) {
	...
	if conf.SystemConfig.Mode == "slave" {
		util.Log().Warning("You are running Vfoy as slave node, if you are using slave storage policy, please enable CORS feature in config file, otherwise file cannot be uploaded from Master site.")
	}
}
