...
func AdminNews(c *gin.Context) {
	...
	r := request.NewClient()
	res := r.Request("GET", "https://forum.vfoy.org/api/discussions?include=startUser%2ClastUser%2CstartPost%2Ctags&filter%5Bq%5D=%20tag%3A"+tag+"&sort=-startTime&page%5Blimit%5D=10", nil)
	if res.Err == nil {
